...
class ISO8583 {
    ...
    //mengembalikan format data dalam format yg benar
    ...
    //mengkalkulasi bitmap dari elemen data
    ...
    //parsing string iso dan mengambil value mti
    ...
    //melakukan parsing string iso dan mengambil value bitmap    
    private function _parseBitmap() {
        ...
        //menyimpan data elemen  dengan karakter '?'
    ...
    //parsing string iso dan mengambil elemen data
    ...
    //method: menambahkan data elemen
    ...
    //method: mengambil data elemen
    public function getData() {
        return $this->_data;
    }

    //method: mengambil bitmap
    public function getBitmap() {
        return $this->_bitmap;
    }

    //method: mengambil mti
    public function getMTI() {
        return $this->_mti;
    }

    //method: mengambil iso dengan data yang komplit
    public function getISO() {
        $this->_iso	= $this->_mti. $this->_bitmap. implode($this->_data);
        return $this->_iso;
    }
         
    //method: menambahkan string ISO
    ...
    //method: return true kalau string iso sudah dalam format 8583, return false bila tidak
    public function validateISO() {
        return $this->_valid['mti'] && $this->_valid['bitmap'] && $this->_valid['data'];
    }
    
    //method: menghapus data elemen
